...
constutes direct or contributory patent infringement, then any patent
...
This project is based on [Vercel AI Chatbot](https://github.com/vercel/ai-chatbot),
licensed under the Apache License 2.0.

### Third-Party Licenses

This project uses open-source software licensed under various terms. See
`pnpm-lock.yaml` for the full dependency tree and individual license files.
